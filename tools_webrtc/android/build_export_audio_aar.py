...
"""Script to generate libexport_audio.aar for distribution.

The script has to be run from the root src folder.
./tools_webrtc/android/build_export_audio_aar.py
...
NEEDED_SO_FILES = ['libexport_audio_so.so']
JAR_FILE = 'lib.java/sdk/android/libexport_audio.jar'
MANIFEST_FILE = 'sdk/android/AndroidManifest.xml'
TARGETS = [
    'sdk/android:libexport_audio',
    'sdk/android:libexport_audio_so',
]
...
def _ParseArgs():
    parser = argparse.ArgumentParser(description='libexport_audio.aar generator.')
    parser.add_argument(
        '--build-dir',
        type=os.path.abspath,
        help='Build dir. By default will create and use temporary dir.')
    parser.add_argument('--output',
                        default='libexport_audio.aar',
                        type=os.path.abspath,
    ...
    parser.add_argument('--use-unstripped-libs',
                        action='store_true',
                        default=False,
                        help='Use unstripped .so files within libexport_audio.aar')
